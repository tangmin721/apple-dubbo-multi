package com.cachexic.apple.common.mybatis.tool.generation.bean;

import com.cachexic.apple.common.utils.AppStringUtils;
...
public class EntityInfo{
	...
	private void parse(Class<?> clazz) {
		...
		for(Field field:superClazz.getDeclaredFields()){
			...
			//驼峰式数据库字段
			eField.setColumnName(AppStringUtils.camelToUnderline(field.getName()));
