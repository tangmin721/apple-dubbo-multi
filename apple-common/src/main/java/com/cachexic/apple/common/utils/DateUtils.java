package com.cachexic.apple.common.utils;

import com.cachexic.apple.common.utils.validate.ValidateUtils;
...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	...
	public static final SimpleDateFormat SHORT_DATE_DOT_FORMAT = new SimpleDateFormat("yyyy.MM.dd");
	public static final SimpleDateFormat SHORT_DATE_DASH_FORMAT = new SimpleDateFormat("yyyy-MM-dd");
	...
	public static Date guessDate(String str){
		...
		Date d = (Date)dateConverter.convert(Date.class, str);
		return d;
	}
	
	public static void main(String[] args) {
		System.out.println(new Date().after(DateUtils.addMinute(new Date(), -10)));
		Date date1 = org.apache.commons.lang3.time.DateUtils.addMinutes(new Date(), -1);
		Date date2 = org.apache.commons.lang3.time.DateUtils.addMinutes(date1, 5);
