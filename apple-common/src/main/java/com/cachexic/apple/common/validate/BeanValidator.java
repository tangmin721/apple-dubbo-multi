package com.cachexic.apple.common.validate;
...
public class BeanValidator {
	...
	/*	TestTable testTable = new TestTable();
		testTable.setName("");
		testTable.setBirthday(DateUtils.SHORT_DATE_FORMAT.parse("2018-10-11"));
		testTable.setAge(129);
		testTable.setSex(2);
		testTable.setEmail("aaffffaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa@ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
		System.out.println("::::校验结果："+JSON.toJSONString(BeanValidator.validateResult(testTable,Insert.class)));*/
	}
